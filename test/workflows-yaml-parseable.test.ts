...
//
// `ai-app-integration-tests`'s workflows use the `run: |` block-scalar
// form today and are YAML-safe, so this lock is the inverse safety
// net: it makes the unparseable-shape failure *cannot* land here
...
//
// This is the twelfth and final hop of the portfolio-ops#30
// propagation arc — all 12 portfolio repos now carry the lock.
//
// Related: portfolio-ops#27, portfolio-ops#28, portfolio-ops#30,
// llm-eval-harness#60, agent-orchestration-platform#41,
// mcp-server-cookbook#46, this repo's #36.
...
describe("workflows YAML parseability lock (#36)", () => {
