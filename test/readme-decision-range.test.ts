...
// `agent-orchestration-platform`, `mcp-server-cookbook`, and
// `nextjs-streaming-ai-patterns`. This is the **twelfth and final**
// portfolio repo — invariant is now portfolio-wide.
//
